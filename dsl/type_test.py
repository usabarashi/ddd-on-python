...
def test_immutable_sequence_init():
    ...
    assert [] == ImmutableSequence([]) == []
    assert [] == ImmutableSequence(()) == []
    # assert [] == ImmutableSequence({}) == [] # Syntax Error
    sequence = ImmutableSequence([0, 1, 2])
    assert isinstance(sequence, ImmutableSequence)
    ...
    assert (
        [0, 2, 4]
        == ImmutableSequence([element * 2 for element in sequence])
        == [0, 2, 4]
    )
...
def test_immutable_sequence_add():
    ...
    assert isinstance(im_collection, ImmutableSequence)
    ...
    assert isinstance(ii_collection, ImmutableSequence)
...
def test_immutable_sequence_add_warning_case():
    ...
    assert not isinstance(mi_collection, ImmutableSequence)
...
def test_immutable_sequence_append():
    ...
    assert isinstance(appended_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_extend():
    ...
    assert isinstance(extended_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_insert():
    ...
    assert isinstance(inserted_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_remove():
    ...
    assert isinstance(removed_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_pop():
    ...
    assert isinstance(poped_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_sort():
    ...
    assert isinstance(sorted_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_reverse():
    ...
    assert isinstance(reversed_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
...
def test_immutable_sequence_copy():
    ...
    assert isinstance(copied_sequence, ImmutableSequence)
    assert isinstance(sequence, ImmutableSequence)
